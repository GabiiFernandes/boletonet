...
namespace BoletoNet
{
    ...
    {   /*
        EntradaConfirmada = 1,
        BaixaManualConfirmada = 2,
        AbatimentoConcedido = 3,
        AbatimentoCancelado = 4,
        VencimentoAlterado = 5,
        UsoEmpresaAlterado = 6,
        PrazoProtestoAlterado = 7,
        PrazoDevolucaoAlterado = 8,
        AlteracaoConfirmada = 9,
        AlteracaoReemissaoBoletoConfirmada = 10,
        AlteracaoProtestoPDevolucaoConfirmada = 11,
        AlteracaoDevolucaoPProtetoConfirmada = 12,
        EmSer = 20,
        Liquidacao = 21,
        LiquidacaoEmCartorio = 22,
        BaixaPorDevolucao = 23,
        BaixaPorProtesto = 25,
        TituloEnviaCartorio = 26,
        SustacaoProtesto = 27,
        EstornoProtesto = 28,
        EstornoSituacaoProtesto = 29,
        AlteracaoDoTitulo = 30,
        TarifaSobreTituloVencido = 31,
        OutrasTarifasDeAlteracao = 32,
        EstornoBaixaLiquidacao = 33,
        TarifasDiversas = 34, //valor total das tarifas cobradas, exceto de liquidação
        LiquidacaoOnline = 35,
        EstonoLiquidacaoOnline = 36,

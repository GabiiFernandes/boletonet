    ...
    internal class Banco_Cecred : AbstractBanco, IBanco {
        ...
        private string GerarDetalheSegmentoPRemessaCNAB240(Boleto boleto, int numeroRegistro) {
            try {
                ...
                reg.CamposEDI.Add(new TCampoRegistroEDI(TTiposDadoEDI.ediAlphaAliEsquerda_____, 0196, 025, 0, boleto.NumeroControle, ' '));                         // posição 196-220 (025) - Identificação do Título na Empresa.

    ...
    internal class Banco_Itau : AbstractBanco, IBanco
    {
        ...
        public string GerarDetalheRemessaCNAB400(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                _detalhe += Utils.FitStringLength((boleto.Avalista != null ? boleto.Avalista.CPFCNPJ + " " + boleto.Avalista.Nome : ""), 30, 30, ' ', 0, true, true, false);
        ...
        public override DetalheRetorno LerDetalheRetornoCNAB400(string registro)
        {
            try
            {
                ...
                detalhe.IOF = iof / 100;
                decimal valorAbatimento = !String.IsNullOrEmpty(registro.Substring(227, 13)) ? Convert.ToUInt64(registro.Substring(227, 13)) : 0;
